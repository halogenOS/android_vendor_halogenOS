...
#           (C) 2020    The Custom Open Sauce Project
#
...
if __name__ == '__main__':
    ...
    default_gerrit = 'https://review.customproject.co'
    ...
    for item in mergables:
        ...
        if args.gerrit == default_gerrit:
            ...
            if args.pull:
                cmd = ['git pull --no-edit custom', item['fetch'][method]['ref']]
            else:
                cmd = ['git fetch custom', item['fetch'][method]['ref']]
            if args.quiet:
                cmd.append('--quiet')
            else:
                print(cmd)
